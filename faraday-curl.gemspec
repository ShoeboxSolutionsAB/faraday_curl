...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Prints CURL compatible commands for the HTTP requests you're making"
  spec.description   = "Prints CURL compatible commands for the HTTP requests you're making"
